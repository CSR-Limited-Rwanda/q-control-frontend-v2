    ...
    return (
        <div className="form-container">
            ...
            <div className="field-group">
                ...
                <div className="grouped-inputs">
                    <div className="field-group">
                        <label htmlFor="family_first_name">First Name <span className="required">*</span></label>
                        <input
                            type="text"
                        ...
                        {isFieldInvalid('family_notified.first_name') && (
                            <div className="error-message">
                                <span>{getFieldError('family_notified.first_name')}</span>
                            </div>
                        )}
                    </div>
                    <div className="field-group">
                        <label htmlFor="family_last_name">Last Name <span className="required">*</span></label>
                        <input
                            type="text"
                            id="family_last_name"
                        ...
                        {isFieldInvalid('family_notified.last_name') && (
                            <div className="error-message">
                                <span>{getFieldError('family_notified.last_name')}</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="grouped-inputs">
                    <div className="field-group">
                        <USDatePicker
                            ...
                            onChange={handleChange}
                            isInvalid={isFieldInvalid('date_family_notified')}
                            errorMessage={getFieldError('date_family_notified')}
                            required={true}
                        />
                    </div>
                    <div className="field-group">
                        <label htmlFor="time_family_notified">Time Notified <span className="required">*</span></label>
                        <CustomTimeInput
                            name="time_family_notified"
                            value={formData.time_family_notified || ''}
                            onChange={handleChange}
                            placeholder="HH:MM"
                            className={isFieldInvalid('time_family_notified') ? 'invalid' : ''}
                        />
                        {isFieldInvalid('time_family_notified') && (
                            <div className="error-message">
                                <span>{getFieldError('time_family_notified')}</span>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className="field-group">
                ...
                <div className="grouped-inputs">
                    <div className="field-group">
                        <label htmlFor="notified_by_first_name">First Name <span className="required">*</span></label>
                        <input
                            type="text"
                        ...
                        {isFieldInvalid('notified_by.first_name') && (
                            <div className="error-message">
                                <span>{getFieldError('notified_by.first_name')}</span>
                            </div>
                        )}
                    </div>
                    <div className="field-group">
                        <label htmlFor="notified_by_last_name">Last Name <span className="required">*</span></label>
                        <input
                            type="text"
                        ...
                        {isFieldInvalid('notified_by.last_name') && (
                            <div className="error-message">
                                <span>{getFieldError('notified_by.last_name')}</span>
                            </div>
                        )}
                    </div>
                </div>
