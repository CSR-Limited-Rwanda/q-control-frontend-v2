...
const ModifyGrievanceIncident = ({ data, incidentId, investigation }) => {
    ...
    const handleFileChange = async (event) => {
        ...
        try {
            ...
            const response = await mediaAPI.post(
                `/incidents/grievance/${incidentId}/documents/new/`,
                formData
            );
    ...
    const handleModify = async (incidentStatus) => {
        ...
        const incidentData = {
            ...
            form_initiated_by: formInitiatedByFirstName && formInitiatedByLastName
                ? {
            ...
            complaint_made_by: complaintByFirstName && complaintByLastName
                ? {
            ...
            outcome: outcome,
            administrator_notified: administratorFirstName && administratorLastName
                ? {
