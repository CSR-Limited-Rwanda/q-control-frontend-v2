...
const ModifyLostFound = ({ data }) => {
    ...
    const [itemDescription, setItemDescription] = useState(incident?.item_description);
    ...
    const [dateLetterSent, setDateLetterSent] = useState(incident?.date_letter_sent);
                    ...
                    <div className="inputs-group modify-inputs">
                        ...
                        <div className="half">
                            <div className="field name">
                                ...
                                <input
                                    onChange={(e) => setPersonWhoFoundPropertyFirstName(e.target.value)}
                            ...
                            <div className="field name">
                                ...
                                <input
                                    onChange={(e) => setPersonWhoFoundPropertyLastName(e.target.value)}
