        ...
        <div key={investigation.id} className="incident-details">
          ...
          <div className="number-mrn">
            ...
            <div className="phone-number">
              ...
              <h4>
                <DateFormatter dateString={investigation.date_of_hire} />
              </h4>
            </div>
            <div className="phone-number">
              <small>Date of birth</small>
              <h4>
                <DateFormatter dateString={investigation.date_of_birth} />
              </h4>
            </div>
            <div className="phone-number">
              <small>Martial status</small>
              <h4>{investigation.marital_status || "Not provided"}</h4>
            </div>
          </div>
          ...
          <div className="number-mrn">
            <div className="field small-field">
              ...
              <h4>{investigation.part_of_body_injured || "Not provided"}</h4>
            </div>
            <div className="field small-field">
              <label htmlFor="city">Nature of the injury</label>
              <h4>{investigation.nature_of_injury || "Not provided"}</h4>
            </div>
          </div>
          <div className="number-mrn">
            <div className="field small-field">
          ...
          <div className="number-mrn">
            <div className="phone-number">
              ...
              <h4>{investigation.witnesses || "Not provided"}</h4>
            </div>
            <div className="phone-number">
              <label htmlFor="city">Event location</label>
              <h4>{investigation.event_location || "Not provided"}</h4>
            </div>
          </div>
          <div className="number-mrn">
            <div className="field small-field">
              <label htmlFor="city">What caused the event:</label>
              <h4>{investigation.cause_of_event || "Not provided"}</h4>
            </div>
            <div className="field small-field">
              <label htmlFor="city">Date of event</label>
              <h4>
                <DateFormatter dateString={investigation.date_of_event} />
              </h4>
            </div>
            <div className="field small-field">
              <label htmlFor="city">Time of event</label>
              <h4>{investigation.time_of_event || "Not provided"}</h4>
            </div>
          </div>
          <div className="number-mrn">
            <div className="field small-field">
          ...
          <div className="number-mrn">
            <div className="phone-number">
              ...
              <h4>
                <DateFormatter dateString={investigation.date_claim_notified} />{" "}
              </h4>
            </div>
            <div className="phone-number">
              <label htmlFor="city">Claim Number</label>
              <h4>{investigation.claim || "Not provided"}</h4>
            </div>
            <div className="phone-number">
              <label htmlFor="city">Went to see a doctor/hospital </label>
              <h4>{investigation.went_to_doctor_or_hospital ? "Yes" : "No"}</h4>
            </div>
          </div>
          <div className="number-mrn">
            <div className="phone-number">
              ...
              <h4>
                {investigation.doctor_info?.last_name || "Not provided"}{" "}
                {investigation.doctor_info?.first_name || "Not provided"}
              </h4>
            </div>
            <div className="phone-number">
              <label htmlFor="city">Hospital Name </label>
              <h4>{investigation.hospital_name || "Not provided"}</h4>
            </div>
            <div className="field small-field">
              <label htmlFor="city">
              ...
              <h4>{investigation.recommendations || "Not provided"}</h4>
            </div>
          </div>
          ...
          <div className="number-mrn">
            <div className="phone-number">
              ...
              <h4>
                {investigation.created_by?.last_name || "Not provided"}{" "}
                {investigation.created_by?.first_name || "Not provided"}
              </h4>
            </div>
