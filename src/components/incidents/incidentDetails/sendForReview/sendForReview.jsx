...
const SendForReview = ({ path, incidentID, handleClose, data }) => {
  ...
  const [requireApprovalEachMember, setRequireApprovalEachMember] =
    useState(false);
        ...
        <div className="popup-content" ref={popupContentRef}>
          ...
          {selectedChoice === "template" && currentStep === 2 ? (
            ...
            <div className="template-confirmation">
              ...
              <p>
                This incident will be sent for review using the selected
                template.
              </p>
            </div>
            ...
            <div className="user-fields">
              ...
              <div className="radio-buttons">
                <div
                  className="radio"
                  onClick={() => setRequireApprovalEachMember(true)}
                >
                ...
                <div
                  className="radio"
                  onClick={() => setRequireApprovalEachMember(false)}
                >
                  {!requireApprovalEachMember ? <CheckSquare2 /> : <Square />}
            ...
            <div className="users-confirmation">
              ...
              <p>
                <strong>Task Days:</strong> {taskDays}
              </p>
              <p>
                <strong>Require All Approvals:</strong>{" "}
                {requireApprovalEachMember ? "Yes" : "No"}
              </p>
              {comment && (
                <p>
