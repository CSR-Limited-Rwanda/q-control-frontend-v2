...
const ReviewGroupsDetailsContent = () => {
    ...
    useEffect(() => {
        const fetchReviewGroup = async () => {
            try {
                const response = await api.get(`/permissions/review-groups/${reviewId}/`)
    ...
    useEffect(() => {
        const fetchGroupMembers = async () => {
            try {
                const response = await api.get(`/permissions/review-groups/${reviewId}/members/`)
                ...
                <div className="review-group-details-contents">
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <p className="review-created-by-name">{reviewGroup.created_by || 'N/A'}</p>
                        </div>
                        <div className="col">
