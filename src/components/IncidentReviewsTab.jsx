        ...
        <div className="reviews-list">
          {reviews.map((review) => (
            <div key={review.id} className="review-item">
              <ProfilePlaceHolder
                fullName={`${review.created_by.first_name} ${review.created_by.last_name}`}
              />
              <div className="review-item-content">
                <div className="name-position">
                  ...
                  <div className="postilion">
                    <PositionCard
                      position={review.created_by.position}
                      itemsToShow={1}
                    />
                  </div>
                </div>
...
export const NewReviewForm = ({ incidentId, apiLink, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await createReview(incidentId, apiLink, {
