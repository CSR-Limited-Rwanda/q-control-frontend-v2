        ...
        <div className="filters">
          ...
          <div className="checkbox">
            <input
              type="checkbox"
              id="requireApproval"
              checked={filters.require_approval}
              onChange={requireApprovalChange}
            />
          ...
          <div className="buttons">
            <button type="button" className="gray" onClick={clearFilters}>
              Clear
            </button>
            <button className="primary" onClick={toggleFilters}>
              Apply Filters
            </button>
          </div>
        </div>
