...
import UpdateAdverseDruReactionForm from "@/components/incidents/updateIncidents/UpdateAdverseDrugPage";
...
const ModifyMedicalAdverseDrugReactionIncidentPageContent = ({}) => {
  ...
  return isLoading ? (
    ...
    <UpdateAdverseDruReactionForm data={incident} />
  ) : (
    "No data"
  );
};
...
const BreadCrumbs = () => {
  ...
  return (
    <div className="breadcrumbs">
      ...
      <MoveRight />
      <Link className="current-page"> Update</Link>
    </div>
  );
};
...
const ModifyMedicalAdverseDrugReactionIncidentPage = () => {
  ...
  return (
    <DashboardLayout
      children={<ModifyMedicalAdverseDrugReactionIncidentPageContent />}
    />
  );
};
